...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST', 'farforre.mysql.tools'),
            'port'      => env('DB_PORT', 3306),
            'database'  => env('DB_DATABASE', 'farforre_laravell'),
            'username'  => env('DB_USERNAME', 'farforre_laravell'),
            'password'  => env('DB_PASSWORD', '2-fk3)V7jU'),
            'charset'   => 'utf8mb4',
        ...
        'opencart' => [
            'driver'    => 'mysql',
            'host'      => env('OC_DB_HOST', 'farforre.mysql.tools'),
            'port'      => env('OC_DB_PORT', 3306),
            'database'  => env('OC_DB_DATABASE', 'farforre_db'),
            'username'  => env('OC_DB_USERNAME', 'farforre_db'),
            'password'  => env('OC_DB_PASSWORD', 'gPpAHTvv'),
            'charset'   => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
